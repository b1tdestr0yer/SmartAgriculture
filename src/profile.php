...
<?php
    ...
    function form1($withErrors)
    {
        ...
        if(isset($_POST['password']))
        {
            ...
            {
                $validString .= "<br>Parola a fost actualizată!";
                updateUserPass($_COOKIE['userID']);
            }

            else
            {
                $errorString .= "<br>Parola este invalidă! Trebuie să aibă cel puțin 3 caractere!";
            }
        }
    ...
    function form2($withErrors)
    {
        ...
        if(isset($_POST['latitude']) and isset($_POST['longitude']))
        {
            if($withErrors)
            {
                if($ok1 == 0 or $ok2 == 0)
                {
                    return "Latitudinea si / sau longitudinea sunt incorecte!";
                }
            ...
            else
            {
                if($ok != 0 and $ok2 != 0)
                {
                    ...
                    return "Latitudinea si longitudinea au fost modificate!";
                }
...
<div id="wrapper">
        ...
        <div id="content"  style="background: url('img/signup2.png');background-color:rgba(0, 0, 0, 0.5); background-opacity: 0.2;">
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top" style="position: absolute; top: 0; width: 100vw; z-index: 1;">
				<div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
					<div class="list-group list-group-horizontal" style="height: 50px; z-index: 0;"><a class="list-group-item list-group-item-action text-nowrap text-left" style="width: 200px;background: #ffffff;" href="/index.php"><i class="fas fa-tachometer-alt"></i><span style="margin: 3px;">Panou de Control</span><a href="/index.php"></a></a>
						<a
							class="list-group-item list-group-item-action active text-center bg-success" href="/profile.php"><i class="fas fa-user"></i><span>Profil</span></a><a href="/profile.php"></a><a class="list-group-item list-group-item-action text-center" style="width:250px;" href="/messages.php"><i class="fa fa-commenting"></i><span>Contact</span></a></div>
                    ...
                    <div class="col">
                        <div class="card  ">
                            ...
                            <div class="card-body mb-2" >
								...
								<button class="btn btn-success btn-sm" style="height: 3rem" type="submit" onclick="window.location.replace('index.php');">Salvează</button>
						...
						<div class="card-body">
						<form action="profile.php" method="POST">
								<div class="form-group"><label for="address"><strong>Latitudine</strong></label><input class="form-control" type="text" placeholder="<?php echo getColumnDataFromID("latitude", $_COOKIE["userID"]);?>" name="latitude" required></div>
								<div class="form-row">
									<div class="col">
										<div class="form-group"><label for="city"><strong>Longitudine</strong></label><input class="form-control" type="text" placeholder="<?php echo getColumnDataFromID("longitude", $_COOKIE["userID"]);?>" name="longitude" required></div>
									</div>
								</div>
