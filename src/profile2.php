...
<div id="wrapper">
	...
	<footer class="text-light bg-success sticky-footer" style="margin-top: 2rem;">
            <div class="container my-auto">
                <div class="text-center my-auto copyright" style="font-size: 17px;"><span style="text-align: center;">Copyright © Floareasoarelui 2020</span></div>
            </div>
